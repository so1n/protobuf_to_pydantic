...
proto_target=$(uv run python -c "from google.protobuf import __version__;from protobuf_to_pydantic._pydantic_adapter import is_v1;target_p = 'proto' if __version__ > '4.0.0' else 'proto_3_20';target_p += '_pydanticv1' if is_v1 else '_pydanticv2';print(target_p)")
