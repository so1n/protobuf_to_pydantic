...
python_file_name_list=("gen_p2p_code.py" "gen_simple_code.py" "gen_text_comment_code.py" "gen_validate_code.py" "p2p_validate_by_comment_gen_code.py" "gen_enum_desc_code.py")
echo ""
