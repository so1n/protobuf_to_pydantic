...
module = importlib.import_module(f"example.{target_p}.example.example_proto.validate.demo_pb2")
message_class_list = []
...
def gen_code() -> None:
    pydantic_model_to_py_file(
        ...
        *[msg_to_pydantic_model(model, parse_msg_desc_method="PGV") for model in message_class_list],
