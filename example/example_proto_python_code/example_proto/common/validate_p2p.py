...
class TimestampRules(BaseModel):
    required: bool = FieldInfo(default=False)
    const: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    lt: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    lte: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    gt: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    gte: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
