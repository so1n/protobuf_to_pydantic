...
class TimestampRules(BaseModel):
    ...
    le: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    gt: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    ge: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    ...
    enable: bool = FieldInfo(default=False)
    default: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    default_factory: str = FieldInfo(default='')
    miss_default: bool = FieldInfo(default=False)
    alias: str = FieldInfo(default='')
    description: str = FieldInfo(default='')
    example: datetime.datetime = FieldInfo(default_factory=datetime.datetime.now)
    example_factory: str = FieldInfo(default='')
    field: str = FieldInfo(default='')
    type: str = FieldInfo(default='')
    title: str = FieldInfo(default='')
