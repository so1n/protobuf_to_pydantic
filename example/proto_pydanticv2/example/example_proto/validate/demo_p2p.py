...
class RepeatedTest(BaseModel):
    ...
    items_duration_test: typing.List[typing_extensions.Annotated[TimedeltaType, Gt(gt=timedelta(seconds=10)), Lt(lt=timedelta(seconds=20))]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
...
class AnyTest(BaseModel):
    ...
    in_test: Any = Field(default_factory=Any, json_schema_extra={"any_in": ["type.googleapis.com/google.protobuf.Duration", "type.googleapis.com/google.protobuf.Timestamp"]}) 
