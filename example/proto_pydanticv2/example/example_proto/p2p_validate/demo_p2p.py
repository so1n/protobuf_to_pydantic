...
class FloatTest(BaseModel):
    ...
    type_test: typing_extensions.Annotated[float, None, Interval(gt=None, ge=None, lt=None, le=None), None, None] = Field(default=0.0, json_schema_extra={}) 
...
class Int32Test(BaseModel):
    ...
    type_test: typing_extensions.Annotated[float, None, Interval(gt=None, ge=None, lt=None, le=None), None, None] = Field(default=0, json_schema_extra={}) 
...
class Uint32Test(BaseModel):
    ...
    example_factory: int = Field(default=0, json_schema_extra={"example": int}) 
    field_test: int = CustomerField(default=0, json_schema_extra={}) 
    type_test: typing_extensions.Annotated[int, None, Interval(gt=None, ge=None, lt=None, le=None), None] = Field(default=0, json_schema_extra={}) 
    title_test: int = Field(default=0, title="title_test", json_schema_extra={}) 
    extra_test: int = Field(default=0, json_schema_extra={"customer_int": 1, "customer_string": "c1"}) 
...
class StringTest(BaseModel):
    ...
    type_test: typing_extensions.Annotated[str, None, Len(min_length=0, max_length=None), PydanticGeneralMetadata()] = Field(default="", json_schema_extra={}) 
...
class BytesTest(BaseModel):
    ...
    type_test: typing_extensions.Annotated[str, None, Len(min_length=0, max_length=None), PydanticGeneralMetadata()] = Field(default=b"", json_schema_extra={}) 
...
class MapTest(BaseModel):
    ...
    pair_test: typing.Dict[str, int] = Field(default_factory=dict, json_schema_extra={"map_max_pairs": 5, "map_min_pairs": 1}) 
    keys_test: typing.Dict[typing_extensions.Annotated[str, MinLen(min_length=1), MaxLen(max_length=5)], int] = Field(default_factory=dict, json_schema_extra={}) 
    values_test: typing.Dict[str, typing_extensions.Annotated[int, Ge(ge=5), Le(le=5)]] = Field(default_factory=dict, json_schema_extra={}) 
    keys_values_test: typing.Dict[typing_extensions.Annotated[str, MinLen(min_length=1), MaxLen(max_length=5)], typing_extensions.Annotated[DatetimeType, gt_now(True)]] = Field(default_factory=dict, json_schema_extra={}) 
    ...
    extra_test: typing.Dict[str, int] = Field(default_factory=dict, json_schema_extra={"customer_int": 1, "customer_string": "c1"}) 
...
class RepeatedTest(BaseModel):
    ...
    items_string_test: typing.List[typing_extensions.Annotated[str, MinLen(min_length=1), MaxLen(max_length=5)]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
    items_double_test: typing.List[typing_extensions.Annotated[float, Gt(gt=1.0), Lt(lt=5.0)]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
    items_int32_test: typing.List[typing_extensions.Annotated[int, Gt(gt=1), Lt(lt=5)]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
    items_timestamp_test: typing.List[typing_extensions.Annotated[DatetimeType, Gt(gt=1600000000.0), Lt(lt=1600000010.0)]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
    items_duration_test: typing.List[typing_extensions.Annotated[TimedeltaType, Ge(ge=timedelta(seconds=10)), Le(le=timedelta(seconds=10))]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
    items_bytes_test: typing.List[typing_extensions.Annotated[bytes, MinLen(min_length=1), MaxLen(max_length=5)]] = Field(default_factory=list, min_length=1, max_length=5, json_schema_extra={}) 
    ...
    extra_test: typing.List[str] = Field(default_factory=list, json_schema_extra={"customer_int": 1, "customer_string": "c1"}) 
...
class AnyTest(BaseModel):
    ...
    not_in_test: Any = Field(default_factory=Any, json_schema_extra={"any_not_in": ["type.googleapis.com/google.protobuf.Duration", "type.googleapis.com/google.protobuf.Timestamp"]}) 
    in_test: Any = Field(default_factory=Any, json_schema_extra={"any_in": [Any(type_url='type.googleapis.com/google.protobuf.Duration'), "type.googleapis.com/google.protobuf.Timestamp"]}) 
    default_test: Any = Field(default=Any(type_url='type.googleapis.com/google.protobuf.Duration'), json_schema_extra={}) 
    ...
    example_test: Any = Field(default_factory=Any, json_schema_extra={"example": "type.googleapis.com/google.protobuf.Duration"}) 
...
class DurationTest(BaseModel):
    ...
    const_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"duration_const": timedelta(seconds=1, microseconds=500000)}) 
    range_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"duration_gt": timedelta(seconds=5, microseconds=500000), "duration_lt": timedelta(seconds=10, microseconds=500000)}) 
    range_e_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"duration_ge": timedelta(seconds=5, microseconds=500000), "duration_le": timedelta(seconds=10, microseconds=500000)}) 
    in_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"duration_in": [timedelta(seconds=1, microseconds=500000), timedelta(seconds=3, microseconds=500000)]}) 
    not_in_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"duration_not_in": [timedelta(seconds=1, microseconds=500000), timedelta(seconds=3, microseconds=500000)]}) 
    default_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default=timedelta(seconds=1, microseconds=500000), json_schema_extra={}) 
    default_factory_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={}) 
    miss_default_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(json_schema_extra={}) 
    alias_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, alias="alias", json_schema_extra={}) 
    desc_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, description="test desc", json_schema_extra={}) 
    example_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"example": timedelta(seconds=1, microseconds=500000)}) 
    example_factory_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"example": timedelta}) 
    field_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = CustomerField(default_factory=timedelta, json_schema_extra={}) 
    title_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, title="title_test", json_schema_extra={}) 
    type_test: timedelta = Field(default_factory=timedelta, json_schema_extra={}) 
    extra_test: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta, json_schema_extra={"customer_int": 1, "customer_string": "c1"}) 
...
class TimestampTest(BaseModel):
    ...
    range_test: datetime = Field(default_factory=datetime.now, json_schema_extra={"timestamp_gt": 1600000000.0, "timestamp_lt": 1600000010.0}) 
    range_e_test: datetime = Field(default_factory=datetime.now, json_schema_extra={"timestamp_ge": 1600000000.0, "timestamp_le": 1600000010.0}) 
    ...
    within_test: datetime = Field(default_factory=datetime.now, json_schema_extra={"timestamp_within": timedelta(seconds=1)}) 
    within_and_gt_now_test: datetime = Field(default_factory=datetime.now, json_schema_extra={"timestamp_gt_now": True, "timestamp_within": timedelta(seconds=3600)}) 
    ...
    extra_test: datetime = Field(default_factory=datetime.now, json_schema_extra={"customer_int": 1, "customer_string": "c1"}) 
